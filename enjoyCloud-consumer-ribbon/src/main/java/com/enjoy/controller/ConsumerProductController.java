...
public class ConsumerProductController {
	  ...
	  private static final String PRODUCT_TOPIC = "ENJOYCLOUD-PROVIDER-PRODUCT";
	
	  public static final String PRODUCT_GET_URL = "http://"+PRODUCT_TOPIC+"/prodcut/get/";
	  public static final String PRODUCT_LIST_URL="http://"+PRODUCT_TOPIC+"/prodcut/list/";
	  public static final String PRODUCT_ADD_URL = "http://"+PRODUCT_TOPIC+"/prodcut/add/";
